...
<head>
    ...
    <link rel="stylesheet" href="../public/css/campus-life.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="../public/css/campusnews.css?v=<?php echo time(); ?>">
    ...
    <div class="BannerContent">
        <div class="pinMoto">
            ...
            <div class="backgroundDiv">
                <video class="backgroundVideo" src="../assets/video/av1.mkv" autoplay loop muted></video>
            </div>
        </div>
            ...
            <div class="contentText">
                <div class="content__inner">
                    <div class="content-grid">
                        <h1 class="college-main-title">College Updates</h1>

                        <div class="college-content-wrapper">
                            <div class="college-column">
                                <div class="college-author-box">
                                    <img src="../assets/svce-logo.png" alt="Tom Arends" class="college-author-picture">
                                    <h3 class="college-author-name">Tom Arends</h3>
                                    <h4 class="college-author-role">Creatief Directeur</h4>
                                    <p class="college-author-text">Full service ingenieursbureau WEPRO heeft een stevige
                                        groei-ambitie en vond in Blink de partij om hier vorm aan te geven. We
                                        onderzochten de flow in de organisatie, de mensen, het gevoel en de principes:
                                        het hart van de organisatie. Dit hebben we omgezet naar een aansprekende
                                        brandstory. De basis voor een nieuw beeldmerk, pay-off en huisstijl. We laten je
                                        zien wat het is geworden na de officiële launch.</p>
                                </div>
                            </div>

                            <div class="college-column">
                                <div class="college-author-box">
                                    <img src="../assets/svce-logo.png" alt="Jelke te Loeke"
                                        class="college-author-picture">
                                    <h3 class="college-author-name">Jelke te Loeke</h3>
                                    <h4 class="college-author-role">Communicatie Adviseur</h4>
                                    <p class="college-author-text">In opdracht van het Graafschap College in Doetinchem
                                        organiseren wij samen met Mood Concepts het Innovatiefestival voor de
                                        Achterhoek. De vier dagen, met elk een eigen karakter, staan in het teken van de
                                        innovatieve, ondernemende en verbindende kracht uit de Achterhoek. Het
                                        Innovatiefestival is van 25 t/m 28 maart op het DRU Industriepark in Ulft.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="college-main-container">
            <div class="college-layout-grid">
                ...
                <section class="college-content-section">
                    ...
                    <div class="college-button-container">
                        <a href="../public/cultural.php" class="no-underline">
                ...
                <section class="college-content-section">
                    ...
                    <div class="college-button-container">
                        <a href="../public/sports.php" class="no-underline">
    ...
    <div>
        ...
        <section class="marquees__wrapper">
            ...
            <div class="marquee" data-duration="5">
                <div class="marquee__group">
                    <div class="item1">
                        <img src="../assets/logos/amazon.png" alt="Five Days at Memorial" srcset="">
                    </div>
                    <div class="item1">
                    ...
                    <div class="item1">
                        <img src="../assets/logos/ey.png" alt="Servant">
                    </div>
                    <div class="item1">
